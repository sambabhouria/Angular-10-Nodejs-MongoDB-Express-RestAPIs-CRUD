...
export class ListCustomersComponent implements OnInit {
  ...
  showCustomer: Customer | undefined ;
  isSelected: boolean = false;
  deletedCustomer: Customer | undefined;
  ...
  deleteCustomer(){
    ...
    this.deletedCustomer && this.customerService.deleteCustomer(this.deletedCustomer.id)
   ...
   */
  updateCustomer() {
    this.showCustomer  && this.customerService.updateCustomer(this.showCustomer)
                      .subscribe((message: Message) => {
                        console.log(message);
